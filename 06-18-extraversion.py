...
#%%
#for each variable of interest, try in out and bonachich:
...
maininds = ['agreeableness','extraversion','personality_attractive']
    ...
    for mainind in maininds:
        ...
        for maindep in maindeps:
            ...
            for variable in variables:
                ...
                form = '%s ~ %s * %s' % (maindep,mainind,variable)
                est = smf.ols(formula=form, data=dataset).fit()
                fullout = est.summary()
                output = fullout.tables[1]
